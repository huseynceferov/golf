...
class Operation
{
    ...
    {
        return 'Modules\\'.MODULE_ADMIN.'\\Controllers\\'.ucfirst($this->tableName);
    }
    ...
    public function getPositionForNew($id,$direction='up',$update=false)
    {
        $class =  $this->getClassName() ;
        $model = $this->findModel($id);
    ...
    public function deleteModel($ids=[])
    {
        ...
        Session::setFlash('success','Məlumatlar silindi');
    }
