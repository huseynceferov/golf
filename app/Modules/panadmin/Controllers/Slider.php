...
use Modules\panadmin\Models\SliderModel as TableModel;
use Models\LanguagesModel;
use Core\View;
use Helpers\Url;
use Modules\panadmin\Models\AlbumsModel;

class Slider extends MyController
{
    ...
    public static $imageFolder = 'slider';
...
//                Session::setFlash('error', 'Şəkil problemi');
