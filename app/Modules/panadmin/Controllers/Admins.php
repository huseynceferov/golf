...
use Modules\panadmin\Models\AdminsModel as TableModel;
use Models\LanguagesModel;
use Core\View;
use Helpers\Url;
use Modules\panadmin\Models\AdminsModel;
...
class Admins extends MyController
{
    ...
    public function update($id)
    {
        ...
        if(parent::adminRole() > 1 && $model['role'] == 1) {
            Url::redirect(MODULE_ADMIN."/".$this->dataParams["cName"]);
        }
    ...
    {
        if($id == Session::get('auth_session_id')) {
