                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <?php foreach($data["rows"]  as $row){ ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="fancybox" rel="group" href="<?= Url::filePath()."/".$row["image"]?>" title="<?=$row["title_".$defaultLang]?>"><img class="image-field" src="<?= Url::filePath()."/".$row["thumb"]?>"/></a>
                                    ...
                                    <td><?php
                                        if(!empty($row["link"])) {
                                            ...
                                            echo 'Əlavə link təyin olunmayıb';
                                        }
                                        ?>
                                    </td>
