                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="tab-content form-content">
                            ...
                            <h5><b>Ana kateqoriya:</b> <?= \Modules\admin\Models\CategoriesModel::getCategoryName($data['result']['parent_id']) ?></h5>
                            <h5><b>Slug:</b> <?= $data['result']['slug'] ?></h5>
