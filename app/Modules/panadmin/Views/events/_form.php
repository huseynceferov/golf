            ...
            <div class="col-md-12">
                ...
                foreach($languages as $language){
                    ...
                    <div class="tab-pane fade <?= $li_class?>" id="lang-<?= $language["name"]?>">
                        ...
                        <div class="form-group">
                            <label for="short_text_<?= $language["name"]?>">Short text (<?= $language["name"]?>)</label>
                            <textarea class="form-control " id="short_text_<?= $language["name"]?>" rows="5" name="short_text_<?= $language["name"]?>"><?=$model?$model["short_text_".$language["name"]]:''?></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="arena_<?= $language["name"]?>">Sport arena (<?= $language["name"]?>)</label>
                            <input class="form-control" id="arena_<?= $language["name"]?>" name="arena_<?= $language["name"]?>" value="<?=$model?$model["arena_".$language['name']]:''?>">
                        </div>
                        <div class="form-group">
                            <label for="event_date_<?= $language["name"]?>">Event date (<?= $language["name"]?>)</label>
                            <input class="form-control" id="event_date_<?= $language["name"]?>" name="event_date_<?= $language["name"]?>" value="<?=$model?$model["event_date_".$language['name']]:''?>">
                        </div>
