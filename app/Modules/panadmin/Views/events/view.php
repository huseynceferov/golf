    ...
    <div class="col-lg-12">
        <div class="panel panel-green">
            <div class="panel-heading">
                <h3>Show Events #ID: <?= $data['result']['id'] ?></h3>
            </div>
                        ...
                        <div class="tab-content form-content">
                            ...
                            foreach ($languages as $language):
                                ...
                                <div class="tab-pane fade <?= $li_class ?>" id="lang-<?= $language["name"] ?>">
                                    ...
                                    <h5><b>Location:</b> <?= $data['result']['location_'.$language['name']] ?></h5>
                                    <h5><b>Arena:</b> <?= $data['result']['arena_'.$language['name']] ?></h5>
                                    <h5><b>Event Date:</b> <?= $data['result']['event_date_'.$language['name']] ?></h5>
